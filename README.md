...
```
# Output:
<img width="637" height="376" alt="image" src="https://github.com/user-attachments/assets/ff098870-76a9-4b5f-8e87-7b2ea7431a9b" />
...
```
# Output:
<img width="631" height="191" alt="image" src="https://github.com/user-attachments/assets/5076b123-874d-4af9-a129-b4bc1b2a178d" />
...
```
# Output:
<img width="637" height="235" alt="image" src="https://github.com/user-attachments/assets/0f368856-695b-41eb-a74f-6a729cf35d22" />
...
```
# Output:
<img width="627" height="320" alt="image" src="https://github.com/user-attachments/assets/bf442a12-7831-47f4-ab24-545a734b2306" />
...
int main() {
    ...
    // Function call to display array elements
    displayArray(arr, 5);
...
```
# Output:
<img width="492" height="187" alt="Screenshot 2026-09-16 164620" src="https://github.com/user-attachments/assets/6277a280-47e3-4da3-b68a-02edbac33a72" />
